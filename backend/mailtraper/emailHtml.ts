            ...
            <body>
              <div class="email-container">
                <div class="email-header">
                  <h1>Welcome to Varun Food center!</h1>
                </div>
                <div class="email-body">
                  <p>Hi ${name},</p>
                  <p>Congratulations! Your email has been successfully verified.</p>
                  <p>We are excited to have you on board at Varun Food Center. Explore our platform and enjoy our services.</p>
                  <p>If you have any questions or need assistance, feel free to reach out to us.</p>
                  <p>Best Regards,<br/>The Varun Food Team</p>
                </div>
                <div class="email-footer">
                  <p>&copy; 2024 Varun Food Center. All rights reserved.</p>
                </div>
              </div>
            </body>
          </html>
        ...
        <body>
          <div class="email-container">
            ...
            <div class="email-body">
              ...
              <a href="${resetURL}" class="button" id="btn">Reset Password</a>
              <p>If you didn't request a password reset, please ignore this email.</p>
              <p>Thank you,<br/>The Varun Food Center Team</p>
            </div>
            <div class="email-footer">
              <p>&copy; 2024 Varun Food Center. All rights reserved.</p>
            </div>
